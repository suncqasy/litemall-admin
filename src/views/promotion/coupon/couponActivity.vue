  ...
  <div class="app-container">
    ...
    <div class="table-layout">
      <el-row>
        ...
        <el-col :span="4" class="table-cell-title">优惠券介绍</el-col>
        <el-col :span="4" class="table-cell-title">优惠券标签</el-col>
      ...
      <el-row>
        ...
        <el-col :span="4" class="table-cell-title">使用范围</el-col>
      ...
      <el-row>
        ...
        <el-col :span="4" class="table-cell" style="line-height: initial;">{{ getTimeScope() }}</el-col>
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="用户优惠券序号" prop="id" sortable/>
